...
public class SellerListController implements Initializable, DataChangeListener {
	...
	public void onBtNewAction(ActionEvent event) {
		...
		createDialogForm(obj, "/gui/SellerForm.fxml", null);
	}
	...
	private void initializeNodes() {
		...
		tableColumnEmail.setCellValueFactory(new PropertyValueFactory<>("eamil"));
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.initModality(Modality.WINDOW_MODAL); // Enquanto você não fechar essa janela não pode acessar a
																// janela anterior
